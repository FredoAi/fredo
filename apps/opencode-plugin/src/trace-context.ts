/**
 * trace-context.ts — W3C trace context parsing for the Fredo OpenCode plugin.
 *
 * Parses traceparent and tracestate headers and builds a remote parent context
 * so all emitted spans are parented under the injected trace context.
 */
