/**
 * probe.ts — OTLP endpoint connectivity probe for the Fredo OpenCode plugin.
 *
 * Opens a TCP connection to the parsed endpoint host:port to verify reachability
 * before the OTel SDK initialises. Resolves within 5 seconds.
 */
...
/**
 * Parses an OTLP endpoint URL into host and port.
 * Falls back to 4317 for http/https without explicit port.
 */
...
/**
 * Probes the OTLP endpoint via TCP connection.
 * Resolves within 5 seconds (timeout).
 */
