...
const Cubes: React.FC<CubesProps> = ({
  ...
  cellGap,
  borderStyle = '1px solid rgba(147, 51, 234, 0.3)',
  faceColor = 'rgba(6, 0, 16, 0.8)',
  shadow = '0 0 10px rgba(147, 51, 234, 0.2)',
  autoAnimate = true,
  rippleOnClick = true,
  ...
  return (
    <div style={wrapperStyle}>
      <div ref={sceneRef} style={{ display: 'grid', ...sceneStyle }}>
        {cells.map((_, r) =>
          cells.map((__, c) => (
            <div
              key={`${r}-${c}`}
            ...
            >
              <span style={{ position: 'absolute', pointerEvents: 'none', inset: '-36px' }} />
