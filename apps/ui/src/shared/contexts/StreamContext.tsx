...
/**
 * @deprecated StreamEvent is deprecated. Use FredoEvent instead.
 * FredoEvent provides a more complete event structure with eventType, provider, transport, and metadata.
 * All event consumers should migrate to FredoEvent. StreamEvent will be removed in a future version.
 */
