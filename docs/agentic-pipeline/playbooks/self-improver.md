...
2. **Dispatch the planning cluster in parallel** (software-architect, ui-ux-expert, qa-expert) with the backlog as the brief and the A2A file path; wait for all three planners' section drafts + `## Discussion` points in the A2A file.
