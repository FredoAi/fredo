...
- **effectiveness:** **Confirmed** (2026-09-05, #2823) — the G-032 sync required the reset idiom after both the `checkout --` denial and the UTF-16 corruption; the branch reached the tester synced (F-16..F-20 present).
