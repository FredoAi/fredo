...
| `done` | Feature labeled `done`, branches cleaned, human review + close | Cleanup complete (issue labeled `done` from cleanup, left OPEN for human close) | Self-Improver + human review | — |
