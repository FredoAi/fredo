...
- **Agent playbooks** — edit the `docs/agentic-pipeline/playbooks/*.md` that made the wrong decision; agent identity (`.opencode/agents/*.md`) changes are proposed to the human as exact text.
