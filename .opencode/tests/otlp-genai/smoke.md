...
- [ ] S-4: Adapter unit suite compiles and passes - `cargo test` in `apps/tauri/src-tauri` (adapter modules; `opencode.rs` + `contract_633.rs` + `contract_633_ac6c.rs`) exits 0
