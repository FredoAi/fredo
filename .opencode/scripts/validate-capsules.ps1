...
Invoke-WithLogging -Source "validate-capsules.ps1" -Body {
  $files = $CapsuleFiles | ForEach-Object { $_ -split ',' } | ForEach-Object { $_.Trim() } | Where-Object { $_ }
  ...
  if ($errors.Count -gt 0) {
    ...
    $msg = "Capsule validation FAILED ($errorCount issues):`n`n"
