...
| 2026-06-11 | Spec #174 | Retrospective must verify backlog issue is closed before declaring spec complete | Issue #174 left OPEN after merge; human had to ask about it. Add "gh issue close / project status → Done" as a retro checklist step. |
#181: 4/4 capsules merged, 0 bugs � All 4 capsules first-pass approved; 1 pre-existing test failure (SessionStart?node) unrelated to changes
