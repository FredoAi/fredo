...
| 2026-06-17 | #252 | 1/1 merged, 6 bugs fixed live | EventSubscription system + ChatNode-only Mission Monitor. 6 live bugs (isReplay guard, nodeMap rebuild, replay overwrite, flashing, session_id path, ghost sessions). 17 files +637/-1166. Rust adapter session_id fix � multi-terminal sessions now work.
