...
| 2026-06-09 | Spec #141/#142 | Planner needs fallback dispatch authority when subagent session DB is down — 7+ dispatches failed with insert conflicts | Without subagents, Planner had to become Coder (write source fixes, config, test logic) violating role boundaries. Mitigation: detect dispatch failures early and flag to human. |#174: 2/2 capsules resolved, 0 bugs � Capsule 1 merged first-pass, Capsule 2 pre-verified clean; EARS coverage missing REQ-5/REQ-6 in capsule requirement_ids
#173: 3/3 capsules merged, 0 bugs � All first-pass merges; REQ-5 (CI/Agent immutability) not in any capsule requirement_ids (enforced via forbidden_changes)
